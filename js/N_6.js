...
} else if (cuota > limiteCuota) {
    alert(" Rechazado: la cuota mensual de $" + cuota + " supera el tope permitido de " + limiteCuota);
} else {
    alert(" Pre-Aprobado! Su credito fue aceptado. Cuota mensual calculada : " + cuota);
}